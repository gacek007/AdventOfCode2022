...
int checking_round(char o, char m) {
    ...
    if (o == 'A' && m == 'X') { winpoint = 0; choisepoint = 3; }
    if (o == 'A' && m == 'Y') { winpoint = 3; choisepoint = 1; }
    if (o == 'A' && m == 'Z') { winpoint = 6; choisepoint = 2; }

    if (o == 'B' && m == 'X') { winpoint = 0; choisepoint = 1; }
    if (o == 'B' && m == 'Y') { winpoint = 3; choisepoint = 2; }
    if (o == 'B' && m == 'Z') { winpoint = 6; choisepoint = 3; }

    if (o == 'C' && m == 'X') { winpoint = 0; choisepoint = 2; }
    if (o == 'C' && m == 'Y') { winpoint = 3; choisepoint = 3; }
    if (o == 'C' && m == 'Z') { winpoint = 6; choisepoint = 1; }
